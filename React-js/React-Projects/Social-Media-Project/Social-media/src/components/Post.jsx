...
const Post=({post})=>{
  ...
  <div className="card-body">
    <h5 className="card-title">{post.tittle}<span className="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger" onClick={()=>{deletePost(post.id)}}>
    <MdDelete />
  </span></h5>
